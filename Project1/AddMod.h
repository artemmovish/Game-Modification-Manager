...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->изменитьPrewToolStripMenuItem->Click += gcnew System::EventHandler(this, &AddMod::изменитьPrewToolStripMenuItem_Click);
			// 
			...
			this->изменитьIconToolStripMenuItem->Click += gcnew System::EventHandler(this, &AddMod::изменитьIconToolStripMenuItem_Click);
			// 
			// PanelDict
			// 
			...
			this->textName->Text = L"НАЗВАНИЕ МОДА";
			// 
			// butStart
			// 
